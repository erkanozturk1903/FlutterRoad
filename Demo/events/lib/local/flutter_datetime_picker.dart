...
import 'package:events/local/src/date_model.dart';
      ...
      child: Container(
        ...
        child: NotificationListener(
          ...
          child: CupertinoPicker.builder(
            ...
            itemExtent: InitialDims.space12,
        ...
        children: <Widget>[
          SizedBox(
            ...
            child: CupertinoButton(
              pressedOpacity: 0.3,
              padding:
                  EdgeInsetsDirectional.only(start: InitialDims.space4, top: 0),
              child: FxText(
                cancel,
                tag: Tag.h4,
          ...
          SizedBox(
            ...
            child: CupertinoButton(
              pressedOpacity: 0.3,
              padding:
                  EdgeInsetsDirectional.only(end: InitialDims.space4, top: 0),
              child: FxText(
                done,
                tag: Tag.h4,
                color: InitialStyle.secondaryTextColor,
...
class _BottomPickerLayout extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    double maxHeight = InitialDims.space20 * 3;
    if (showTitleActions == true) {
      maxHeight += InitialDims.space10;
    }
